...
import demo.hilt.containers.dep.ViewDependency
import javax.inject.Inject

@AndroidEntryPoint
@WithFragmentBindings
class MyFragmentView : View {
    ...
    @Inject
    lateinit var viewDependency: ViewDependency

    fun printDependency() {
        println("---- MyFragmentView ----")
        ...
        println("viewDependency = $viewDependency")
    }
}